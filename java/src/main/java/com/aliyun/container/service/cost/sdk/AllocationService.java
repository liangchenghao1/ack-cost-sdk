...
import com.aliyun.container.service.cost.sdk.model.AllocationResponse;
...
public class AllocationService {
     ...
     * @param client SDK客户端
     */
    public AllocationService(Client client) {
        this.client = client;
    }
     ...
     */
    public AllocationResponse getAllocation(AllocationRequest request) throws CostError {
        // 构建URL
        HttpUrl.Builder urlBuilder = HttpUrl.parse(
                client.getConfig().getApiServer() + 
                "/api/v1/namespaces/kube-system/services/ack-metrics-adapter-api-service:8080/proxy/v2/allocation")
                .newBuilder();
        ...
        if (request.getTargetType() != null) {
            urlBuilder.addQueryParameter("targetType", request.getTargetType());
        }
