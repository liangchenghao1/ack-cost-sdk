...
// CostV2Service Cost V2 API服务
type CostV2Service struct {
	client *Client
}

// CostV2Properties Kubernetes对象属性
type CostV2Properties struct {
...
type CostV2Data struct {
	...
	Properties           CostV2Properties `json:"properties"`
...
// CostV2Response Cost V2 API响应
type CostV2Response struct {
	Data []map[string]*CostV2Data `json:"data"`
}

// CostV2Request Cost V2 API请求参数
type CostV2Request struct {
	// Window 查询的持续时间
...
// GetCostV2 查询Cost V2成本数据
func (s *CostV2Service) GetCostV2(ctx context.Context, req *CostV2Request) (*CostV2Response, error) {
	// 构建URL
	apiURL := fmt.Sprintf("%s/api/v1/namespaces/kube-system/services/ack-metrics-adapter-api-service:8080/proxy/v2/cost", s.client.config.APIServer)
